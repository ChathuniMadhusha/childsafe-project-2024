...
// const checkUpdatess = (entity,entityName) => {
//     updates = "";
...
//
//     if (loggeduser1.student != null){
//         let errors = checkErrorss(loggeduser1.student);
//         if (errors == ""){
//             let updates = checkUpdatess(loggeduser1.student,"student");
//             if(updates != ""){
...
//     }
//     else if (loggeduser1.teacher != null){
//         let errors = checkErrorss(loggeduser1.teacher);
//         if (errors == ""){
//             let updates = checkUpdatess(loggeduser1.teacher,"teacher");
//             if(updates != ""){
//                 //Show the confirmation box when the Add button is clicked
...
//     }
//     else if (loggeduser1.parent != null){
//         let errors = checkErrorss(loggeduser1.parent);
//         if (errors == ""){
//             let updates = checkUpdatess(loggeduser1.parent,"parent");
//             if(updates != ""){
//                 //Show the confirmation box when the Add button is clicked
